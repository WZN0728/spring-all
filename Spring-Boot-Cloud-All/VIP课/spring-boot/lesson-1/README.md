...
maven 命令方式创建工程：
   ...
   b.然后使用命令 mvn archetype:generate -DgroupId=com.test -DartifactId=my-spring-boot-first-app   -Dversion=1.0.0-SNAPSHOT -DinteractiveMode=false 创建项目，其中archetype属于插件形式的命令执行
