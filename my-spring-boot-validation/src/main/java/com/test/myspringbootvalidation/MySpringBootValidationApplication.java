package com.test.myspringbootvalidation;
...
import com.test.myspringbootvalidation.controller.interceptor.UserInterceptor;

@SpringBootApplication
public class MySpringBootValidationApplication implements WebMvcConfigurer {

	public static void main(String[] args) {
		SpringApplication.run(MySpringBootValidationApplication.class, args);
	}
